        ...
        <v-col cols="12" md="4" lg="4">
            <v-row>
                ...
                <v-col cols="12" class="my-8">
                    ...
                    <p class="ml-6">
                        Tools and insights to empower your journey.Click on cards or links for redirect to relevant
                        resource.
                    </p>
                </v-col>
                <!-- Section: Search -->
                    ...
                    <v-card class="bg-transparent" elevation="0" min-height="550">
                        <v-row v-if="toggle === 1">
                            <v-col v-for="(pdf, i) in apiFetch.pdfBucket" :key="i" cols="auto">
                                <v-card @click="redirect(pdf.primary.pdf_link)" width="110" height="175"
                                    variant="outlined" class="pa-2" rounded="lg">
                        ...
                        <v-row v-if="toggle === 0">
                            <v-col cols="12">
                                <v-expansion-panels v-model="panel" variant="accordion" tile :flat="true"
                                    class="border-b-trbl">
