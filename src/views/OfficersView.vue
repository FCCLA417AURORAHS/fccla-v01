        ...
        <v-col cols="12" md="8" lg="4">
            <v-row>
                ...
                <v-col cols="12" class="mb-4">
                    ...
                    <p class="ml-6">
                        FCCLA officers are student leaders who guide the organization, plan events, and inspire members.
                        They
                        uphold
                    ...
                    <v-card min-height="700" class="bg-transparent" elevation="0">
                        <v-row v-if="toggle === 1">
                            <v-col v-for="(officer, i) in apiFetch.officersBucket" :key="i" cols="auto">
                                <v-card @click="dialogCtrl(officer)" width="150" height="150" variant="outlined"
                        ...
                        <v-row v-if="toggle === 0">
                            <v-col cols="12">
                                <v-list density="compact">
                                    <v-list-item @click="dialogCtrl(officer)"
                                        v-for="(officer, i) in apiFetch.officersBucket" :key="i"
                                        class="border-b-trbl mb-2" rounded="lg">
                ...
                <v-dialog v-model="dialog">
                    <v-card min-width="350" min-height="485" class="pa-3 border-r-trbl" rounded="xl">
                        ...
                        <v-row>
                            ...
                            <v-col cols="6">
                                <v-img class="border-b-b" :src="tempOfficer.primary.officer_image.url" height="150"
                                    contain>
                                    <template v-slot:placeholder>
                                        <div class="d-flex align-center justify-center fill-height">
                                            <v-progress-circular color="grey-lighten-4"
                            ...
                            <v-col cols="12">
                                <v-card height="400" class="pa-3 bg-grey-lighten-4" elevation="0"
                                    ...
                                    <p class="font-weight-bold">Best piece of advice for someone thinking about joining?
                                    </p>
                                    <p>
