...
<template>
    <v-row>
        <v-col cols="0" md="4" lg="4" class="d-none d-md-flex">
        </v-col>
        <v-col cols="12" md="4" lg="4">
            <v-row>
                ...
                <v-col cols="12" class="my-8">
                    ...
                    <p class="ml-6">
                        FCCLA events provide opportunities for members to develop leadership skills, showcase talents,
                        and
                        connect with
                        peers. From conferences and workshops to competitive events, each experience fosters growth,
                        teamwork,
                        and
                        career readiness.
                    </p>
                        ...
                        <v-card v-for="(officer, i) in apiFetch.eventsBucket" :key="i" min-width="320"
                            ...
                            <v-row class="d-flex mt-2">
                                <v-col cols="12" class="d-flex">
                                    <p id="orcFont" class="text-h6 mr-6">NAME: {{ officer.primary.event_name[0].text }}
                                    </p>
                                    <p id="orcFont" class="text-subtitle-2 mt-1">DATE: {{ officer.primary.date[0].text
                                        }}</p>
                                </v-col>
                            </v-row>
                            <!-- unlink -->
